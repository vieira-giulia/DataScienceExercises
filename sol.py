...
assert_almost_equal(10.350448628373906, delay(df)[0])
assert_almost_equal(6.496649996322718, delay(df)[1])
...
def high_delay(df):
    df['Delay'] = df['CRSArrTime'] - df['CRSDepTime']
    df['Delay'] = df['Delay'].count()
